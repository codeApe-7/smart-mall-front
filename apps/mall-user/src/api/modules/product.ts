...
import type { ProductListItem, ProductQuery } from '@shared/types/mall'
...
export const fetchProductList = (data?: ProductQuery) => request.post<PageResultVO<ProductListItem>>('/product/list', data)
...
}) => request.post<PageResultVO<Record<string, unknown>>>('/product/knowledge/search', data)
