...
import { submitPayment } from '@/api/modules/payment'
import { applyRefund, fetchRefundDetail } from '@/api/modules/refund'
import { confirmReceive, fetchShippingDetail } from '@/api/modules/shipping'
...
export const listOrders = fetchOrderList
export const getOrderDetail = fetchOrderDetail
export { submitPayment, applyRefund, fetchRefundDetail as getRefundDetail, fetchShippingDetail as getShippingDetail, confirmReceive }
